                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu" >
                        ...
                        <li role="presentation">
                            <a role="menuitem" tabindex="-1" href="/category/{{$header_category->id}}">- {{$header_category->category}}</a>
                        </li>
                        @endforeach
...
<div class="basket-item-count"><span class="count" id="quantity">
   {{\Cart::getContent()->count()}}
</span></div>
				<div class="total-price-basket">
					<span class="lbl">cart</span>
					<span class="total-price">
						<span class="sign">Rs.</span><span class="value total">{{\Cart::getTotal()}}</span>
					</span>
				</div>
		...
		<ul class="dropdown-menu">
    					...
    					<div class="row" id="message">
    						@if (\Cart::getContent()->count() > 0)
                                @foreach (\Cart::getContent() as $pro)
                                    <div class="col-xs-4"><div class="image"><a href="/detail/{{$pro->id}}"><img src="{{url('images/'.$pro->attributes->img[0]->image)}}"alt=""></a></div></div><div class="col-xs-7"><h3 class="name"><a href="/detail/{{$pro->id}}">{{$pro->name}}</a></h3><div class="price">Rs.{{$pro->price}}</div></div>
                                @endforeach
                            @endif
    					</div>
				</div><!-- /.cart-item -->
			...
			<div class="clearfix cart-total">
				<div class="pull-right">
						...
						<span class="text">Sub Total :</span><span class='price total'>{{\Cart::getTotal()}}</span>
